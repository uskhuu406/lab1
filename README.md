...
Системд дараах мэдээллүүдийг хадгална:
...
- `sql/1_create_database.sql` — database үүсгэх
- `sql/2_create_tables.sql` — хүснэгтүүд үүсгэх
- `sql/3_insert_data.sql` — жишээ өгөгдөл оруулах
- `sql/4_join_queries.sql` — хүснэгтүүдийг JOIN хийж шалгах
- `sql/5_dbms.sql` — DBMS-ийн 10 үндсэн функцийг турших
