...
Гэхдээ захиалга, хэрэглэгч болон бүтээгдэхүүний мэдээлэл давтагдсан хэвээр байна.

---

## 2NF

Partial dependency-г арилгахын тулд захиалга болон бүтээгдэхүүний мэдээллийг тусад нь салгасан.
...
`Orders` нь захиалгын мэдээллийг, `Product` нь бүтээгдэхүүний мэдээллийг хадгална.
...
Transitive dependency-г арилгахын тулд дам хамааралтай мэдээллүүдийг тусдаа хүснэгтэд салгасан.
...
Тиймээс `Category` болон `Branch` хүснэгтүүдийг тусад нь үүсгэсэн.

Мөн хэрэглэгч, ажилтан, төлбөрийн мэдээллийг тусдаа хүснэгтэд хадгалсан.
...
0NF-ээс 3NF хүртэл нормчлол хийснээр өгөгдлийн давхардал багасч, нийт 8 хүснэгттэй бүтэцтэй өгөгдлийн сан болсон.
